...
CREATE TABLE fee_structure (
    ...
    due_date_day INT DEFAULT 10, -- Day of month when fee is due
...
CREATE TABLE notices (
    ...
    class_id INT NULL, -- If target is specific_class
...
('Admin User', 'admin@school.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin'); -- password: password
